...
- *Wedbush is a US financial services firm offering brokerage, clearing, and wealth management.*
- Built the Payments API that facilitates client fund transfers across the firm.
- Implemented complex transaction recording and state transitions following Event Sourcing principles.
- Developed a balance calculator that derives client balances from recorded transactions.
- Integrated Transactions, Balances, and Positions with Broadridge, the firm's books and records.
- Engineered a credit sweep interest calculation engine that scales to millions of clients.
- Technologies: TS, NestJS, PostgreSQL, BullMQ, AWS, Kubernetes, Terraform, JSONata
...
- *Neurelo is a cloud platform that auto-generates REST and GraphQL APIs over databases.*
...
- Technologies: TS, Go, Node.js, Express, React, REST, GraphQL, PostgreSQL, MongoDB
...
- Took ownership of developing and deploying the iOS and Android apps.
- Technologies: TS, Node.js, Express, React, React Native, GraphQL, PostgreSQL
...
- *Independent contracting for a diamond brokerage and a Web3 NFT client.*
...
- Technologies: TS, NestJS, Vue, GraphQL, EventStoreDB, MongoDB
...
- *FarmLink is a grain-marketing advisory firm and maker of the GrainFox farm-data platform.*
...
- Technologies: Python, JS, Django, Vue, REST, MySQL
...
- *Ideal Fine Cars is a used-car dealership.*
...
- Built the backend REST APIs using Python Flask and MongoDB.
- Automated automotive data collection using Python-based scraping tools.
- Technologies: Python, Flask, Vue, React, Tailwind CSS, MongoDB
...
- Technologies: Express, Angular, T-SQL
...
- *Derman is an early-stage startup.*
- Collaborated with a small team to build an MVP.
- Technologies: Laravel, Vue, Bootstrap, MySQL, Laravel Forge
...
- *Renegade Digital Media is a healthcare and life-sciences marketing agency.*
